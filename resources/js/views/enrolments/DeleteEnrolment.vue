    ...
    <div class="fixed bottom-0 inset-x-0 px-4 pb-4 sm:inset-0 sm:flex sm:items-start sm:justify-center sm:my-48">
        <div class="fixed inset-0 transition-opacity">
            <div class="absolute inset-0 bg-black opacity-25"
                 @click="toggleDeleteEnrolmentModal"></div>
        </div>
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm leading-5 text-gray-500">
                                Are you sure you want to delete this enrolment? This action cannot be undone.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                        <button @click="deleteEnrolment" type="button"
                ...
                <span class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                        <button @click="toggleDeleteEnrolmentModal" type="button"
    ...
    export default {
        ...
        methods: {
            toggleDeleteEnrolmentModal() {
                this.$emit('toggle-delete-enrolment-modal');
            },
            deleteEnrolment() {
                this.$emit('delete-enrolment');
            }
        }
    }
</script>
